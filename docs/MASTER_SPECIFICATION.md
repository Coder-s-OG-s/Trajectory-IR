...
| **Location** | Normative copy lives at [`docs/MASTER_SPECIFICATION.md`](MASTER_SPECIFICATION.md). The root [`README.md`](../README.md) is the project landing page and points here. |

**Project links:** [Landing README](../README.md) · [License (Apache-2.0)](../LICENSE) · [Code of Conduct](../CODE_OF_CONDUCT.md) · [Contributing (DCO)](../CONTRIBUTING.md) · [AI Usage Policy](../AI_POLICY.md) · [Security](../SECURITY.md) · [Maintainers](../MAINTAINERS.md) · [Governance](../GOVERNANCE.md) · [Roadmap](ROADMAP.md) · [Adopters](../ADOPTERS.md) · [Third-party licenses](THIRD_PARTY_LICENSES.md) · [Scope and non-goals](SCOPE_AND_NON_GOALS.md) · [Quickstart (Go first)](../go/QUICKSTART.md) · [Demo / docs site](../website/README.md) · [CNCF Sandbox prep](CNCF_SANDBOX_APPLICATION_OUTLINE.md)
...
```text
trajectory-ir/
  README.md                     # Project landing page (users + contributors)
  docs/MASTER_SPECIFICATION.md  # Master Specification (this file; normative)
  LICENSE                       # Apache-2.0
